...
namespace Warehouse.Persistence.EF.Migrations
{
    ...
    [Migration("20240207081900_Add_Basket_and_UserRoles")]
    partial class Add_Basket_and_UserRoles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Warehouse.Domain.Entities.Basket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Warehouse.Domain.Entities.BasketLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Warehouse.Domain.Entities.OrderLine", b =>
                {
            ...
            modelBuilder.Entity("Warehouse.Domain.Entities.Basket", b =>
                {
                    b.HasOne("Warehouse.Domain.Entities.User", "User")
                        .WithOne("Basket")
                        .HasForeignKey("Warehouse.Domain.Entities.Basket", "UserId")
            ...
            modelBuilder.Entity("Warehouse.Domain.Entities.BasketLine", b =>
                {
                    b.HasOne("Warehouse.Domain.Entities.Basket", "Basket")
